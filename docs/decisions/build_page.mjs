...
const DOCS = ['00-plan.md', '01-format.md', '02-auth.md', '03-api.md', '04-governance.md', '05-bot.md', '06-akl-integration.md', '07-implementation-phase1.md', '08-infrastructure.md', '09-implementation-phase2.md', '10-implementation-phase4.md', '11-implementation-phase3.md'];
